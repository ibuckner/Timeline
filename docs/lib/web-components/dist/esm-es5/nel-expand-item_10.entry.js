...
var ItemCollection = /** @class */ (function () {
    ...
    ItemCollection.prototype.validateClear = function (newValue) {
        if (newValue) {
            for (var _i = 0, _a = Array.from(this.host.children); _i < _a.length; _i++) {
                var el = _a[_i];
...
var ListItem = /** @class */ (function () {
    ...
    Object.defineProperty(ListItem, "style", {
...
var NetworkConnection = /** @class */ (function () {
    ...
    Object.defineProperty(NetworkConnection, "style", {
        get: function () { return ":host([hidden]){display:none !important}"; },
        enumerable: true,
        configurable: true
    });
...
var Slicer$1 = /** @class */ (function () {
    ...
    Object.defineProperty(Slicer$1, "style", {
...
var TextInput = /** @class */ (function () {
    ...
    Object.defineProperty(TextInput, "style", {
        get: function () { return ":host([disabled]){cursor:not-allowed;opacity:0.5;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}:host([hidden]){display:none !important}input{border:2px solid #aaa;-webkit-box-sizing:border-box;box-sizing:border-box;padding:4px;outline:transparent;-webkit-transition:border-color 0.25s ease, color 0.25s ease;transition:border-color 0.25s ease, color 0.25s ease;z-index:9}input:focus{border:2px solid #000}input::-webkit-input-placeholder{color:#aaa}input::-moz-placeholder{color:#aaa}input:-ms-input-placeholder{color:#aaa}input::-ms-input-placeholder{color:#aaa}input::placeholder{color:#aaa}input::-webkit-search-cancel-button{cursor:pointer}"; },
        enumerable: true,
        configurable: true
    });
    return TextInput;
...
var TextTag = /** @class */ (function () {
    ...
    class_1.prototype.onKeyDown = function (ev) {
        if (this.disabled || !this.selectable || ev.keyCode === 229) {
            ev.stopImmediatePropagation();
            ev.preventDefault();
            return;
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return ":host([disabled]),:host([disabled])>mark{cursor:not-allowed;opacity:0.5;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}:host([hidden]){display:none !important}.selectable{cursor:pointer}.text-tag:focus{-webkit-box-shadow:0 0 0 4px #ffcd60;box-shadow:0 0 0 4px #ffcd60;outline:none}mark{-webkit-box-decoration-break:clone;border-radius:0.35em;box-decoration-break:clone;line-height:1.3rem;margin:auto 0.25rem;padding:0.2em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}mark>span{font-size:0.7em;font-weight:bold;text-transform:uppercase}"; },
        enumerable: true,
        configurable: true
    });
    return class_1;
