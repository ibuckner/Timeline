...
const ExpandItem = class {
    constructor(hostRef) {
        ...
        this.loaded = index.createEvent(this, "loaded", 6);
    ...
    render() {
        ...
        return (index.h("details", { tabindex: tab, open: this.open }, index.h("summary", { role: "button", tabindex: "-1" }, index.h("div", { class: "icon", style: iconStyle }, index.h("slot", { name: "icon" })), index.h("div", { class: "title" }, index.h("slot", { name: "title" }))), index.h("div", { style: contentStyle }, index.h("slot", { name: "content" }))));
    }
...
const ItemCollection = class {
    constructor(hostRef) {
         ...
         */
        this.sort = "ASC";
        this.cleared = index.createEvent(this, "cleared", 6);
        this.loaded = index.createEvent(this, "loaded", 6);
        this.sorted = index.createEvent(this, "sorted", 6);
    }
    ...
    render() {
        ...
        const tab = this.disabled ? undefined : 0;
        return (index.h("div", { class: cls, tabindex: tab }, index.h("slot", null)));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
...
const ListItem = class {
    constructor(hostRef) {
        ...
        this.deleting = index.createEvent(this, "deleting", 7);
        this.deleted = index.createEvent(this, "deleted", 7);
        this.loaded = index.createEvent(this, "loaded", 6);
        this.selected = index.createEvent(this, "selected", 6);
    }
    validateClear(newValue) {
        if (newValue) {
    ...
    render() {
        ...
        return (index.h("div", { class: "list-item", tabindex: tab }, index.h("div", { class: bcls, style: bst }), index.h("div", { class: tcls }, index.h("slot", null))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "clear": ["validateClear"]
...
const ModalView = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "modal-view" }, index.h("div", { class: cls }, index.h("slot", null))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "open": ["validateOpen"]
...
const NetworkConnection = class {
    constructor(hostRef) {
        ...
        this.ready = false;
        this.loaded = index.createEvent(this, "loaded", 6);
        this.changed = index.createEvent(this, "changed", 6);
    }
    componentDidLoad() {
        this.loaded.emit(this.host);
        // this.ready = true;
    ...
    render() {
        return (index.h("div", { hidden: this.available }, index.h("slot", null)));
    }
    get host() { return index.getElement(this); }
...
const OnOff = class {
    ...
    input:before { height: ${ht}; width: ${ht} }`;
        return (index.h(index.Host, { "aria-checked": this.on ? "true" : "false" }, index.h("span", null, index.h("style", null, st), index.h("input", { type: "checkbox", checked: this.on, value: "" }))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "on": ["validateOpen"]
...
const Slicer$1 = class {
    constructor(hostRef) {
        ...
        this.ready = false;
        this.cleared = index.createEvent(this, "cleared", 6);
        this.errored = index.createEvent(this, "errored", 6);
        this.loaded = index.createEvent(this, "loaded", 6);
        this.selected = index.createEvent(this, "selected", 6);
    }
    validateClear(newValue) {
    ...
    render() {
        const tab = this.disabled ? undefined : 0;
        return (index.h("div", { class: "slicer", tabindex: tab }, index.h("slot", null)));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "clear": ["validateClear"]
        ...
        const ico = this.rag === -1
            ...
            : this.rag === 0
                ...
                : this.rag === 1
                    ? "circle"
                    : "";
        return (index.h("div", { class: "status-badge" }, index.h("div", { class: "icon" }, index.h("div", { class: ico })), index.h("div", { class: "text" }, index.h("span", null, this.pre), index.h("slot", null), index.h("span", null, this.suf)), index.h("div", { class: "label" }, this.label ? " " + this.label : "")));
    }
    get host() { return index.getElement(this); }
...
const TextInput = class {
    ...
    render() {
        return (index.h("input", { type: this.cleartext ? "search" : "password", maxlength: this.maxlength, minlength: this.minlength, pattern: this.pattern, placeholder: this.placeholder, size: this.width, value: this.value }));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "mask": ["validateMask"]
...
const TextTag = class {
    ...
    render() {
        ...
        return (index.h("mark", { class: cls, tabindex: tab, style: styles }, index.h("slot", null), index.h("span", null, this.label ? " " + this.label : "")));
    }
    get host() { return index.getElement(this); }
...
exports.nel_expand_item = ExpandItem;
exports.nel_item_collection = ItemCollection;
exports.nel_list_item = ListItem;
exports.nel_modal_view = ModalView;
exports.nel_network_connection = NetworkConnection;
exports.nel_on_off = OnOff;
exports.nel_slicer = Slicer$1;
exports.nel_status_badge = StatusBadge;
exports.nel_text_input = TextInput;
exports.nel_text_tag = TextTag;
